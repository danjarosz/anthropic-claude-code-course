...
test("MessageList shows text for assistant message with text parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // The component shows the text but not a loading indicator when text is present
...
test("MessageList handles text parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
